...
@autoreleasepool {
    ...
    while ([rs next]) {
        ...
        FMDBQuickCheck([rs[0] isEqualToString:rs[@"rowid"]]);
        FMDBQuickCheck([rs[1] isEqualToString:rs[@"a"]]);
        FMDBQuickCheck([rs[2] isEqualToString:rs[@"b"]]);
        FMDBQuickCheck([rs[3] isEqualToString:rs[@"c"]]);
    }
    [rs close];
